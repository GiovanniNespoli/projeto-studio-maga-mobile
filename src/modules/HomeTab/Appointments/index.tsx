      ...
      >
        ...
        <View style={{ flexDirection: "column" }}>
          <Containers>
            ...
            <Data>
              {" "}
              <Feather name="calendar" size={18} color="#4F4F4F" /> Hoje, 13:30
            </Data>
          ...
          <Containers>
            ...
            <Data>
              {" "}
              <Feather name="calendar" size={18} color="#4F4F4F" /> Hoje, 14:35
            </Data>
          ...
          <Containers>
            ...
            <Data>
              {" "}
              <Feather name="calendar" size={18} color="#4F4F4F" /> Amanhã,
              11:00
            </Data>
            <View style={{ flexDirection: "row" }}>
              <Btn1>
